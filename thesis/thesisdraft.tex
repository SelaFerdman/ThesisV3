...
In~\autoref{fig:incredi_sym_conduit}, we show the expected PageRank score of IncrediMail in Conduit's PPR and in non-personalized PageRank. As the \autoref{fig:incredi_sym_conduit} shows, IncrediMail clearly benefits from Conduit. As we mentioned in~\autoref{subsub:co_occurrence}

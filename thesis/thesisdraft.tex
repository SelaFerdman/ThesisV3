...
On a validation set consisting of 24 [SELA: Recheck the number] addons, we see 100\% precision meaning that there was not one single addon that would pop up in the ranked list and did not after all belong to the company in the query. Using this procedure, we found 24 addons like that. Need to add the second round iteration.

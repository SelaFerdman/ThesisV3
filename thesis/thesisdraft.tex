...
AN ISSUE: There are several aspects of this problem. Correlations may
...
We split our dataset to 2/3 training set and 1/3 test set (uniformly at random). Since we had about 900,000 instances in our dataset, our training set contained about 600,000 instances which was large enough for modern non-parallelized binary classification systems. [RON: here] After a few unsuccessful attempts, we decreased the training set size by taking all positive instances and a random sample of 1/3 of negative instances.
